...
?>
<div id="comments" class="grid12-7 <?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <?php if (user_is_logged_in() && $comment_form): ?>
  ...
  <?php else: ?>
   <div class="comment-form-wrapper">
<?php echo l('add comment','user/login', array('attributes' => array('class' => 'text-link'), 'query'=> drupal_get_destination())); ?>
  </div>
  <?php endif; ?>
