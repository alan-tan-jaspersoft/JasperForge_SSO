...
function cti_flex_preprocess_page(&$vars) {
	if(isset($vars['node']) && $vars['node']->type == 'question'){
		$vars['theme_hook_suggestions'][] = 'page__question';
	}
}

function cti_flex_preprocess_comment(&$vars) {
	if(isset($vars['node']) && $vars['node']->type == 'question'){
		$vars['theme_hook_suggestions'][] = 'comment__question';
	}
	elseif(isset($vars['node']) && $vars['node']->type == 'answer'){
		$vars['theme_hook_suggestions'][] = 'comment__answer';
	}
}
