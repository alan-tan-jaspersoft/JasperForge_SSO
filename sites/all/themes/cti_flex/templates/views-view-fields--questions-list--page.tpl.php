...
?>
	...
	<div class="stats-wrapper">
		...
		<?php 
			...
			elseif($row->_field_data['nid']['entity']->field_answer_count['und'][0]['count'] > 0) {
		...
		<div class="views-field views-field-field-answer-count<?php echo $answer_class; ?>">
			...
			<div class="stats-label"><?php print format_plural($row->_field_data['nid']['entity']->field_answer_count['und'][0]['count'],'answer','answers'); ?></div>
		</div>
