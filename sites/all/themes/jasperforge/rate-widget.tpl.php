...
<?php print theme('rate_button', array('text' => $links[0]['text'],'href'	=> $links[0]['href'],'class' => "jf_updown-up")); ?>

<div class="jf_updown-score">
	<span class="jf_updown-current-score"><?php print $results['up']-$results['down']; ?></span>
</div>

<?php print theme('rate_button', array('text' => $links[1]['text'],'href'	=> $links[1]['href'],'class' => "jf_updown-down")); ?>
